...
import tech.abc.platform.system.vo.ModuleVO;
...
public class ModuleController extends BaseController {
    ...
    @PreAuthorize("hasPermission(null,'system:module:add')")
    ...
    @PreAuthorize("hasPermission(null,'system:module:modify')")
    ...
    @PreAuthorize("hasPermission(null,'system:module:remove')")
    ...
    @PreAuthorize("hasPermission(null,'system:module:query')")
    ...
    @PreAuthorize("hasPermission(null,'system:module:view')")
