  ...
  <div :val="value_" class="hour">
    ...
    <div class="appoint">
      ...
      <el-checkbox-group v-model="appoint" @change="type = '4'">
        <div v-for="(hours, i) in hourList" :key="i" style="margin-left: 10px; line-height: 25px">
          <el-checkbox v-for="(hour, j) in hours" :key="j" :label="hour" />
        </div>
      </el-checkbox-group>
    </div>
  </div>
...
.hour .appoint .el-checkbox__label {
  width: 20px;
  padding-left: 5px;
}
.hour div {
