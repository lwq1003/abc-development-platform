<template>
  <div class="w-full">
    ...
    <Dialog title="工作流监听器选择" v-model="visible" class="w-150">
      <CollapseTab>
        <el-form :inline="true" :model="queryCondition" label-width="80px" @keyup.enter="query">
          ...
          <el-form-item label="类别">
            <dictionary-select v-model="queryCondition.category" code="WorkflowListenerCategory" />
          </el-form-item>
          <el-form-item label="类型">
            <dictionary-select v-model="queryCondition.type" code="WorkflowListenerType" />
          </el-form-item>
