        ...
        <el-table-column fixed="right" label="操作" width="250">
          <template #default="scope">
            ...
            <el-button
              ...
              type="primary"
              @click="configPermission(scope.row)"
              >权限</el-button
            >
...
export default {
  ...
  methods: {
    add() {
      this.$refs.addPage.init({ id: this.queryCondition.userGroup })
    },
    commonParamChange(param) {
      this.queryCondition.userGroup = param.id
    },
    ...
    savePermissionItem(userGroupIdList) {
      this.api.savePermission(this.currentId, userGroupIdList)
    }
  }
}
</script>
