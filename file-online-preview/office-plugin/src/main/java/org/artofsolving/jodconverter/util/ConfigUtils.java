    ...
    public static String getHomePath() {
        ...
        if (userDir.endsWith("bin")) {
            ...
            if (userDir.contains(MAIN_DIRECTORY_NAME)) {
                ...
                userDir = userDir + separator +"file-online-preview" + separator+ MAIN_DIRECTORY_NAME + separator + "src" + separator + "main";
            }
        }
        return userDir;
    }
    ...
    public static String getOfficePluginPath() {
        ...
        if (userDir.endsWith("bin")) {
            ...
            if (!userDir.contains(OFFICE_PLUGIN_NAME)) {
                userDir = userDir + separator +"file-online-preview" + separator + OFFICE_PLUGIN_NAME;
            }
        }
        return userDir;
    }
